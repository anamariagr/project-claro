                                            ...
                                            <div class="btn-group mar-y-1">
                                                    ...
                                                    (1 Día)    </button>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                    <li><a href="javascript:;" data-price-type-action="prepaid" data-value="hide" data-line="">Ocultar todas las opciones de prepago</a></li>
                                                                    <li><a href="javascript:;" data-price-type-action="prepaid" data-value="show" data-line="">Mostrar todas las opciones de prepago</a></li>
                                                                            <li><a href="javascript:;" data-show-filter-modal="1" data-line="1">Otros Filtros</a></li>
                                                            </ul>
                                                    </div>
                                            </div>
                                            <div className="col-lg-12">
