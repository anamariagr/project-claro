                 ...
                 <div className="row">
                           <div className="col-lg-4">
                                ...
                                <p className="color-list">Datos</p>
                                    ...
                                    <div class="btn-group" ref={this.typeRef}>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <div type="select" ref={this.typeRef}  >
                                            <option class="dropdown-item" >Planes Smartphone</option>
                                            <option class="dropdown-item" >Disponible con cada plan</option>
                                          </div>
                                        </div>
                                        </div>
