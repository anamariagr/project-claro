    ...
    return(
        <div className="row">
                    ...
                    <div className="col-lg-2">
                        ...
                        <button data-html="true" className="btn btn-info btn-xs dropdown-toggle font-2" data-original-title="" data-content="Este paquete vence cada día " data-placement="top" data-toggle="popover" data-container="body" type="button" class="btn btn-info btn-xs text-break font-2" data-stop-propagation="">
                    ...
                    <div className="col-lg-2">
                        <buttom className="btn btn-primary">Ver Detalle</buttom>
                    </div>
        </div>
    )
}
