                           ...
                           <div className="col-lg-4">
                                ...
                                <div className="col-lg-3 section-phone-position">
                                    ...
                                    <form className="filter-list" onSubmit={this.filterPhone}>
                                        <div className="row">
                                        <div className="col-lg-4">
                                    <p className="mb-3 font-size-14"><b>{this.calculateInternet()}</b> </p>
                                    <div className="mb-4"> 
                                    <ReactSlider 
                                    ...
                                    <div className="col-lg-4">
                                        <p className="mb-3 font-size-14"><b>{this.calculateMinutos()}</b> </p>
                                        <div className="mb-4"> 
                                        <ReactSlider
                                                    className="horizontal-slider"
                                                    ref={this.minutosRef}
                                        ...
                                        <div className="col-lg-4">
                                            <p className="mb-3 font-size-14">{this.min()}<b>{this.claculaSms()}</b> </p>
