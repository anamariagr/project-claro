                 ...
                 <div className="row">
                           <div className="col-lg-4">
                                ...
                                <p className="color-list">Datos</p>
                                    ...
                                    <div class="btn-group" >
                                        <select  type="button"  ref={this.typeRef} class="btn btn-section-phone btn-sm dropdown-toggle"  id="exampleFormControlSelect1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
