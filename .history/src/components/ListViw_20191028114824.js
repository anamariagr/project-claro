    ...
    calculateSeptSms(){
     ...
     render(){
      ...
      <div className="row">
          ...
          <nav class="navbar navbar-light bg-light navbar-list">
           ...
           <div className="row">
            ...
            <div class="dropdown ">
              <button class="btn btn-secondary dropdown-toggle drow-list" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Dropdown button
              </button>
                                ...
                                <p className="color-list">Datos</p>
                                  ...
                                  <ReactSlider 
                                    ...
                                    <div className="col-lg-4">
                                        ...
                                        <div className="col-lg-12">
                                        <p className="subtitle">Datos</p>
                              <p className="mb-3 font-size-14-list value-silider"><b className="title-slide-list">{this.calculateMinutos()}</b> </p>
                              <div className="mb-4"> 
                              <ReactSlider
                                        className="horizontal-slider"
                                        ref={this.minutosRef}
                                    ...
                                    />
                                        ...
                                        <div className="col-lg-12">
                                            <p className="mb-3 font-size-14-list value-silider"> <b>{this.claculaSms()}</b> </p>
